        ...
        <CardContent className="text-center space-y-3 relative z-10">
          ...
          {badge.earned ? (
            <div className="space-y-2">
              <Badge variant="default" className="animate-glow bg-gradient-to-r from-gold/70 to-gold/50 text-gold-foreground border-gold/50">
            ...
            <div className="space-y-2">
              <Badge variant="outline" className="border-dashed bg-muted/30">
      ...
      <Card className="glass-card border-gold/30 bg-gradient-to-br from-gold/10 via-accent/5 to-primary/10">
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            ...
            <Badge variant="default" className="animate-glow text-lg px-4 py-2 bg-gradient-to-r from-gold to-gold/70 text-gold-foreground border-gold/50">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between flex-wrap gap-2">
            ...
            <Badge variant="outline" className="text-sm px-3 py-1 bg-gold/10 text-gold border-gold/50">
